...
if __name__ == "__main__":
    ...
    # Rename masks in ground_truth/hole and ground_truth/scratches
    ...
    # gt_root_hole = gt_root/"hole"
    # gt_root_scratch = gt_root/"scratches"
    ...
    for img_path, label in train_split:
        ...
        if "good" in img_name:
            ...
            mask_name = f"{base_name}_mask.png"    #235_good_mask.png 

...
BRACKET_BROWN_DATA_DIR = (PROJECT_ROOT / CONFIG["bracket_brown_data_dir"]).resolve()
...
PROCESSED_BRACKET_BROWN_DATA_DIR = (PROJECT_ROOT / CONFIG["processed_bracket_brown_data_dir"]).resolve()
print(f"Processed bracket black data dir: {PROCESSED_BRACKET_BLACK_DATA_DIR}")
print(f"Processed bracket brown data dir: {PROCESSED_BRACKET_BROWN_DATA_DIR}")
